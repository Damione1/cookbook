...
var RecipeIngredientWhere = struct {
	...
	RecipeID:     whereHelperstring{field: "\"recipe_ingredients\".\"recipe_id\""},
	IngredientID: whereHelperstring{field: "\"recipe_ingredients\".\"ingredient_id\""},
...
var (
	recipeIngredientAllColumns            = []string{"recipe_id", "ingredient_id", "quantity", "unit", "manual_name", "created_at", "updated_at"}
	recipeIngredientColumnsWithoutDefault = []string{"recipe_id", "ingredient_id", "quantity", "unit"}
	recipeIngredientColumnsWithDefault    = []string{"manual_name", "created_at", "updated_at"}
...
func FindRecipeIngredientG(ctx context.Context, recipeID string, ingredientID string, selectCols ...string) (*RecipeIngredient, error) {
...
func FindRecipeIngredient(ctx context.Context, exec boil.ContextExecutor, recipeID string, ingredientID string, selectCols ...string) (*RecipeIngredient, error) {
...
func RecipeIngredientExistsG(ctx context.Context, recipeID string, ingredientID string) (bool, error) {
...
func RecipeIngredientExists(ctx context.Context, exec boil.ContextExecutor, recipeID string, ingredientID string) (bool, error) {
	var exists bool
