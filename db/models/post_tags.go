...
var PostTagWhere = struct {
	...
	ID:        whereHelperint{field: "\"post_tags\".\"id\""},
	PostID:    whereHelperint{field: "\"post_tags\".\"post_id\""},
...
func FindPostTagG(ctx context.Context, iD int, selectCols ...string) (*PostTag, error) {
...
func FindPostTag(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*PostTag, error) {
	postTagObj := &PostTag{}
...
func PostTagExistsG(ctx context.Context, iD int) (bool, error) {
	return PostTagExists(ctx, boil.GetContextDB(), iD)
}

// PostTagExists checks if the PostTag row exists.
func PostTagExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
