...
var (
	blogPostAllColumns            = []string{"id", "title", "slug", "content", "image_id", "created_at", "updated_at", "deleted_at", "excerpt"}
	blogPostColumnsWithoutDefault = []string{"title", "slug", "content"}
	blogPostColumnsWithDefault    = []string{"id", "image_id", "created_at", "updated_at", "deleted_at", "excerpt"}
