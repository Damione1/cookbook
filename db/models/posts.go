...
type Post struct {
	...
	Kind      PostKind    `boil:"kind" json:"kind" toml:"kind" yaml:"kind"`
...
type whereHelperPostKind struct{ field string }

func (w whereHelperPostKind) EQ(x PostKind) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.EQ, x)
}
func (w whereHelperPostKind) NEQ(x PostKind) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.NEQ, x)
}
func (w whereHelperPostKind) LT(x PostKind) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LT, x)
}
func (w whereHelperPostKind) LTE(x PostKind) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LTE, x)
}
func (w whereHelperPostKind) GT(x PostKind) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GT, x)
}
func (w whereHelperPostKind) GTE(x PostKind) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GTE, x)
}
func (w whereHelperPostKind) IN(slice []PostKind) qm.QueryMod {
...
func (w whereHelperPostKind) NIN(slice []PostKind) qm.QueryMod {
	values := make([]interface{}, 0, len(slice))
	for _, value := range slice {
		values = append(values, value)
	}
...
var PostWhere = struct {
	...
	Kind:      whereHelperPostKind{field: "\"posts\".\"kind\""},
	ImageID:   whereHelpernull_Int{field: "\"posts\".\"image_id\""},
...
var (
	postAllColumns            = []string{"id", "title", "slug", "content", "excerpt", "kind", "image_id", "created_at", "updated_at", "deleted_at"}
	postColumnsWithoutDefault = []string{"title", "slug", "kind"}
