...
var PostWhere = struct {
	...
	Slug:      whereHelperstring{field: "\"posts\".\"slug\""},
	Content:   whereHelpernull_String{field: "\"posts\".\"content\""},
	Excerpt:   whereHelpernull_String{field: "\"posts\".\"excerpt\""},
	ImageID:   whereHelpernull_String{field: "\"posts\".\"image_id\""},
...
func (r *postR) GetPostTags() PostTagSlice {
	if r == nil {
		return nil
	}
	return r.PostTags
...
var (
	postAllColumns            = []string{"id", "title", "slug", "content", "excerpt", "image_id", "created_at", "updated_at", "deleted_at"}
	postColumnsWithoutDefault = []string{"title", "slug"}
	postColumnsWithDefault    = []string{"id", "content", "excerpt", "image_id", "created_at", "updated_at", "deleted_at"}
...
func (o *Post) Image(mods ...qm.QueryMod) mediumQuery {
...
func (o *Post) PostTags(mods ...qm.QueryMod) postTagQuery {
	...
	return PostTags(queryMods...)
}

// LoadImage allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for an N-1 relationship.
func (postL) LoadImage(ctx context.Context, e boil.ContextExecutor, singular bool, maybePost interface{}, mods queries.Applicator) error {
	var slice []*Post
	var object *Post
	...
	if singular {
		...
		foreign.R.ImagePosts = append(foreign.R.ImagePosts, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.ImageID, foreign.ID) {
				...
				foreign.R.ImagePosts = append(foreign.R.ImagePosts, local)
				break
			}
		}
	}
...
// SetImageG of the post to the related item.
// Sets o.R.Image to related.
// Adds o to related.R.ImagePosts.
// Uses the global database handle.
func (o *Post) SetImageG(ctx context.Context, insert bool, related *Medium) error {
	return o.SetImage(ctx, boil.GetContextDB(), insert, related)
}

// SetImage of the post to the related item.
// Sets o.R.Image to related.
// Adds o to related.R.ImagePosts.
func (o *Post) SetImage(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Medium) error {
	var err error
	if insert {
	...
	if related.R == nil {
		related.R = &mediumR{
			ImagePosts: PostSlice{o},
		}
	} else {
		related.R.ImagePosts = append(related.R.ImagePosts, o)
	}
...
// Uses the global database handle.
func (o *Post) RemoveImageG(ctx context.Context, related *Medium) error {
...
// Sets o.R.Image to nil.
// Removes o from all passed in related items' relationships struct.
func (o *Post) RemoveImage(ctx context.Context, exec boil.ContextExecutor, related *Medium) error {
	var err error
	...
	for i, ri := range related.R.ImagePosts {
		if queries.Equal(o.ImageID, ri.ImageID) {
			continue
		}

		ln := len(related.R.ImagePosts)
		if ln > 1 && i < ln-1 {
			related.R.ImagePosts[i] = related.R.ImagePosts[ln-1]
		}
		related.R.ImagePosts = related.R.ImagePosts[:ln-1]
		break
	}
	return nil
}

// AddPostTagsG adds the given related objects to the existing relationships
// of the post, optionally inserting them as new records.
// Appends related to o.R.PostTags.
// Sets related.R.Post appropriately.
// Uses the global database handle.
func (o *Post) AddPostTagsG(ctx context.Context, insert bool, related ...*PostTag) error {
	return o.AddPostTags(ctx, boil.GetContextDB(), insert, related...)
}
...
// SetPostTagsG removes all previously related items of the
// post replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Post's PostTags accordingly.
// Replaces o.R.PostTags with related.
// Sets related.R.Post's PostTags accordingly.
// Uses the global database handle.
func (o *Post) SetPostTagsG(ctx context.Context, insert bool, related ...*PostTag) error {
	return o.SetPostTags(ctx, boil.GetContextDB(), insert, related...)
}

// SetPostTags removes all previously related items of the
// post replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Post's PostTags accordingly.
// Replaces o.R.PostTags with related.
// Sets related.R.Post's PostTags accordingly.
func (o *Post) SetPostTags(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*PostTag) error {
	query := "update \"post_tags\" set \"post_id\" = null where \"post_id\" = $1"
	...
	return o.AddPostTags(ctx, exec, insert, related...)
}

// RemovePostTagsG relationships from objects passed in.
// Removes related items from R.PostTags (uses pointer comparison, removal does not keep order)
// Sets related.R.Post.
// Uses the global database handle.
func (o *Post) RemovePostTagsG(ctx context.Context, related ...*PostTag) error {
	return o.RemovePostTags(ctx, boil.GetContextDB(), related...)
}

// RemovePostTags relationships from objects passed in.
// Removes related items from R.PostTags (uses pointer comparison, removal does not keep order)
// Sets related.R.Post.
func (o *Post) RemovePostTags(ctx context.Context, exec boil.ContextExecutor, related ...*PostTag) error {
	if len(related) == 0 {
		return nil
	}
	...
	for _, rel := range related {
		for i, ri := range o.R.PostTags {
			...
			ln := len(o.R.PostTags)
			if ln > 1 && i < ln-1 {
				o.R.PostTags[i] = o.R.PostTags[ln-1]
			}
			o.R.PostTags = o.R.PostTags[:ln-1]
			break
		}
	}
...
func FindPostG(ctx context.Context, iD string, selectCols ...string) (*Post, error) {
...
func PostExistsG(ctx context.Context, iD string) (bool, error) {
