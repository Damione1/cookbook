...
var IngredientWhere = struct {
	...
	ID:        whereHelperint{field: "\"ingredients\".\"id\""},
	Name:      whereHelperstring{field: "\"ingredients\".\"name\""},
	CreatedAt: whereHelpernull_Time{field: "\"ingredients\".\"created_at\""},
	UpdatedAt: whereHelpernull_Time{field: "\"ingredients\".\"updated_at\""},
}
...
func (r *ingredientR) GetRecipeIngredients() RecipeIngredientSlice {
	if r == nil {
		return nil
	}
...
var (
	ingredientAllColumns            = []string{"id", "name", "created_at", "updated_at"}
	ingredientColumnsWithoutDefault = []string{"name"}
	ingredientColumnsWithDefault    = []string{"id", "created_at", "updated_at"}
...
// OneG returns a single ingredient record from the query using the global executor.
func (q ingredientQuery) OneG(ctx context.Context) (*Ingredient, error) {
...
// AllG returns all Ingredient records from the query using the global executor.
func (q ingredientQuery) AllG(ctx context.Context) (IngredientSlice, error) {
...
// CountG returns the count of all Ingredient records in the query using the global executor
func (q ingredientQuery) CountG(ctx context.Context) (int64, error) {
...
func (q ingredientQuery) ExistsG(ctx context.Context) (bool, error) {
...
func (o *Ingredient) RecipeIngredients(mods ...qm.QueryMod) recipeIngredientQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"recipe_ingredients\".\"ingredient_id\"=?", o.ID),
	)
...
func (ingredientL) LoadRecipeIngredients(ctx context.Context, e boil.ContextExecutor, singular bool, maybeIngredient interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`recipe_ingredients.ingredient_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Ingredient) AddRecipeIngredientsG(ctx context.Context, insert bool, related ...*RecipeIngredient) error {
...
// Appends related to o.R.RecipeIngredients.
// Sets related.R.Ingredient appropriately.
func (o *Ingredient) AddRecipeIngredients(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*RecipeIngredient) error {
	var err error
...
// FindIngredientG retrieves a single record by ID.
func FindIngredientG(ctx context.Context, iD int, selectCols ...string) (*Ingredient, error) {
	return FindIngredient(ctx, boil.GetContextDB(), iD, selectCols...)
}

// FindIngredient retrieves a single record by ID with an executor.
// If selectCols is empty Find will return all columns.
func FindIngredient(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Ingredient, error) {
...
func (o *Ingredient) InsertG(ctx context.Context, columns boil.Columns) error {
...
// UpdateG a single Ingredient record using the global executor.
// See Update for more documentation.
func (o *Ingredient) UpdateG(ctx context.Context, columns boil.Columns) (int64, error) {
...
func (q ingredientQuery) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
// UpdateAllG updates all rows with the specified column values.
func (o IngredientSlice) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
func (o *Ingredient) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
...
// DeleteG deletes a single Ingredient record.
// DeleteG will match against the primary key column to find the record to delete.
func (o *Ingredient) DeleteG(ctx context.Context) (int64, error) {
...
func (q ingredientQuery) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o IngredientSlice) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o *Ingredient) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("models: no Ingredient provided for reload")
	}
...
func (o *IngredientSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("models: empty IngredientSlice provided for reload all")
	}
...
// IngredientExistsG checks if the Ingredient row exists.
func IngredientExistsG(ctx context.Context, iD int) (bool, error) {
	return IngredientExists(ctx, boil.GetContextDB(), iD)
}

// IngredientExists checks if the Ingredient row exists.
func IngredientExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
