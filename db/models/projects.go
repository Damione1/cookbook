...
var ProjectWhere = struct {
	...
	ImageID:     whereHelpernull_Int{field: "\"projects\".\"image_id\""},
...
func (r *projectR) GetImage() *Medium {
	if r == nil {
		return nil
	}
	return r.Image
...
func (r *projectR) GetCurriculumVitaeProjects() CurriculumVitaeProjectSlice {
	if r == nil {
		return nil
	}
...
func (r *projectR) GetProjectSkills() ProjectSkillSlice {
	if r == nil {
		return nil
	}
...
var (
	projectAllColumns            = []string{"id", "title", "description", "image_id", "created_at"}
	projectColumnsWithoutDefault = []string{"title"}
	projectColumnsWithDefault    = []string{"id", "description", "image_id", "created_at"}
...
func (o *Project) Image(mods ...qm.QueryMod) mediumQuery {
...
func (o *Project) CurriculumVitaeProjects(mods ...qm.QueryMod) curriculumVitaeProjectQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"curriculum_vitae_projects\".\"project_id\"=?", o.ID),
	)
...
func (o *Project) ProjectSkills(mods ...qm.QueryMod) projectSkillQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"project_skills\".\"project_id\"=?", o.ID),
	)
...
func (projectL) LoadImage(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProject interface{}, mods queries.Applicator) error {
	var slice []*Project
	var object *Project
	...
	if singular {
		...
		foreign.R.ImageProjects = append(foreign.R.ImageProjects, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.ImageID, foreign.ID) {
				...
				foreign.R.ImageProjects = append(foreign.R.ImageProjects, local)
				break
			}
		}
	}
...
func (projectL) LoadCurriculumVitaeProjects(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProject interface{}, mods queries.Applicator) error {
	var slice []*Project
	var object *Project
	...
	query := NewQuery(
		...
		qm.WhereIn(`curriculum_vitae_projects.project_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (projectL) LoadProjectSkills(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProject interface{}, mods queries.Applicator) error {
	var slice []*Project
	var object *Project
	...
	query := NewQuery(
		...
		qm.WhereIn(`project_skills.project_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// Sets o.R.Image to related.
// Adds o to related.R.ImageProjects.
func (o *Project) SetImage(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Medium) error {
	var err error
	if insert {
	...
	if related.R == nil {
		related.R = &mediumR{
			ImageProjects: ProjectSlice{o},
		}
	} else {
		related.R.ImageProjects = append(related.R.ImageProjects, o)
	}
...
// Sets o.R.Image to nil.
// Removes o from all passed in related items' relationships struct.
func (o *Project) RemoveImage(ctx context.Context, exec boil.ContextExecutor, related *Medium) error {
	var err error
	...
	for i, ri := range related.R.ImageProjects {
		if queries.Equal(o.ImageID, ri.ImageID) {
			continue
		}

		ln := len(related.R.ImageProjects)
		if ln > 1 && i < ln-1 {
			related.R.ImageProjects[i] = related.R.ImageProjects[ln-1]
		}
		related.R.ImageProjects = related.R.ImageProjects[:ln-1]
		break
	}
	return nil
}
...
// Appends related to o.R.CurriculumVitaeProjects.
// Sets related.R.Project appropriately.
func (o *Project) AddCurriculumVitaeProjects(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*CurriculumVitaeProject) error {
	var err error
...
// Appends related to o.R.ProjectSkills.
// Sets related.R.Project appropriately.
func (o *Project) AddProjectSkills(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*ProjectSkill) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.ProjectID = o.ID
