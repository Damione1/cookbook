...
type Medium struct {
	...
	MediumURL        string    `boil:"medium_url" json:"medium_url" toml:"medium_url" yaml:"medium_url"`
	WideURL          string    `boil:"wide_url" json:"wide_url" toml:"wide_url" yaml:"wide_url"`
...
var MediumTableColumns = struct {
	...
	MediumURL:        "media.medium_url",
	WideURL:          "media.wide_url",
...
var MediumWhere = struct {
	...
	MediumURL:        whereHelperstring{field: "\"media\".\"medium_url\""},
	WideURL:          whereHelperstring{field: "\"media\".\"wide_url\""},
...
var (
	mediumAllColumns            = []string{"id", "original_filename", "original_url", "thumbnail_url", "medium_url", "wide_url", "created_at"}
	mediumColumnsWithoutDefault = []string{"original_filename", "original_url", "thumbnail_url", "medium_url", "wide_url"}
