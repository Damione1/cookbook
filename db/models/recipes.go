...
type Recipe struct {
	...
	Directions  types.StringArray `boil:"directions" json:"directions,omitempty" toml:"directions" yaml:"directions,omitempty"`
...
var RecipeWhere = struct {
	...
	Directions  whereHelpertypes_StringArray
	...
	Directions:  whereHelpertypes_StringArray{field: "\"recipes\".\"directions\""},
...
func FindRecipeG(ctx context.Context, iD string, selectCols ...string) (*Recipe, error) {
...
func RecipeExistsG(ctx context.Context, iD string) (bool, error) {
